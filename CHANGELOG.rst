...
**Changed**
  Changed psycopg2 bulkloader documentation to use copy_expert instead of copy_from.
  This solves issue #74, where newer psycopg2 versions escape table names to avoid
  sql injection.
